document.addEventListener('DOMContentLoaded', function() {
  ...
  // 1. TYPING EFFECT - VERSI FIX TIDAK NYISA HURUF
...
document.getElementById('formDaftar').addEventListener('submit', function(e) {
  ...
  formData.append('nama', form.nama.value.trim());
  formData.append('wa', wa);
  formData.append('alamat', form.alamat.value.trim());
  formData.append('paket', form.paket.value);
  ...
  .then(() => {
    ...
    if (pesan) {
      pesan.innerText =
        '✅ Pendaftaran berhasil! Tim WBM.NET akan menghubungi Anda 1x24 jam.';
  ...
  function showPopup(speed){
    ...
    document.getElementById('rekomendasiText').innerText = rekomen
