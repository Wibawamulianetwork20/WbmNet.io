...
document.getElementById('formDaftar').addEventListener('submit', function(e) {
  ...
  if(wa.startsWith('08')) wa = '62' + wa.substring(1); // 0812 jadi 62812
  ...
  .then(response => response.text()) // Tambahin ini biar baca respon
  .then(result => {
    console.log(result); // Liat di F12 > Console
